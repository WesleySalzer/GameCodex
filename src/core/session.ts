...
const TOPIC_DOC_MAP: Record<string, string[]> = {
  ...
  "godot particles": ["godot-arch/G12", "particles-theory"],
  "gpuparticles2d": ["godot-arch/G12"],
  "cpuparticles2d": ["godot-arch/G12"],
  ...
  "particle pool": ["godot-arch/G12", "G67"],
  "trail effect": ["godot-arch/G12"],
  "dust particles": ["godot-arch/G12"],
