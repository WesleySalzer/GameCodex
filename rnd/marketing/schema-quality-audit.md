# Schema Quality Audit — gamedev-mcp-server
...
|--------|-------|-------------|-------------|-------|
| **gamedev-mcp-server** | 10 | ~829 | ~83 | **A** |
...
### Longer Version
> "Most MCP servers waste your context window on tool schemas alone — the #1 MCP server globally burns 1,020 tokens before doing anything useful. gamedev-mcp-server delivers 10 specialized tools in 829 tokens. That's 6× more efficient per tool and 19% less total, leaving your context window for actual game development."
...
>
> gamedev-mcp-server: 10 tools, 829 tokens, zero bloat.
