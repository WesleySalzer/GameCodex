...
- **Name:** GameCodex
- **Short description:** Permanent game development knowledge for AI coding assistants. 147+ curated docs covering design patterns, engine architecture, and implementation guides for MonoGame, Godot, and Unity.
...
- **npm package:** `gamecodex`
- **GitHub:** https://gitlab.com/shawn-benson/GameCodex
- **Author:** shawn-benson
- **License:** MIT
- **Transport:** stdio
- **Install command:** `npx -y gamecodex`

### Long Description

GameCodex gives your AI assistant permanent game development knowledge — design patterns, architecture guides, and engine-specific implementation details delivered through MCP.

**147+ curated docs** covering:
...
- Engine guides: MonoGame/Arch ECS (78 guides), Godot 4.4+ (16 docs, growing), Unity (planned)
...
- **Name:** gamecodex
- **Display Name:** GameCodex
- **Description:** Your AI forgets everything mid-project. Give it permanent game development knowledge. 147+ curated docs — design patterns, architecture, engine-specific guides for MonoGame, Godot, and more. Secure stdio-only transport.
...
- **Title:** GameCodex — AI Game Dev Knowledge Base
...
- **Install method:** npm (`npx -y gamecodex`)

### Feature Highlights (for listing)

1. **147+ curated docs** — not scraped, hand-written with AI code generation in mind
2. **Multi-engine** — MonoGame (79 guides), Godot (16 docs), Unity (planned), plus engine-agnostic core
...
- **Name:** GameCodex
- **Description:** Permanent game dev knowledge for your AI. 147+ curated docs on design, architecture, and engine-specific implementation. MonoGame, Godot, Unity. Cross-engine comparison, context-efficient section extraction, stdio-only security.
...
**Suggested:** `🎮 AI game dev knowledge server (MCP). 147+ curated docs — design patterns, architecture, MonoGame, Godot, Unity. Cross-engine comparison. Give your AI permanent gamedev expertise.`
