# Stitch Prompts — gamecodex Marketing

Google Stitch prompt templates for designing marketing/product pages for the gamecodex project. Use at [stitch.withgoogle.com](https://stitch.withgoogle.com/).
...
```
Modern developer tool landing page for "gamecodex" — an AI 
...
"Get Started — npx gamecodex" code snippet button. Dark 
...
hallucinates patterns. gamecodex gives your AI permanent 
gamedev knowledge."
...
Split hero: Left side (red tint): "Without gamecodex" — 
AI output with wrong API calls, deprecated patterns, hallucinated 
functions. Right side (green tint): "With gamecodex" — 
...
marketplace/storefront. Product: "gamecodex Pro" at $9/month.
...
Order summary sidebar: "gamecodex Pro — $9/month"
...
Center: Arrow → "gamecodex" box (highlighted, primary 
accent color)
...
Divider text: "gamecodex" logo/text on the diagonal.
```
...
Bottom: "npx gamecodex" in a code pill.
