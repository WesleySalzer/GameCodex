...
describe("Cross-Engine Search", () => {
  ...
  it("should return results from multiple engines when no filter is applied", async () => {
  ...
  it("should include core docs when filtering by engine", async () => {
    const result = await handleSearchDocs(
  ...
  it("should group by engine when crossEngine=true", async () => {
    const result = await handleSearchDocs(
  ...
  it("should handle case-insensitive engine names", async () => {
    const result = await handleSearchDocs(
  ...
  it("should work without module metadata (backward compatible)", async () => {
    const result = await handleSearchDocs(
      { query: "camera" },
      docStore,
      searchEngine
  ...
  it("should handle engine + category filter combination", async () => {
    const result = await handleSearchDocs(
  ...
  it("should show cross-engine summary in header when results span engines", async () => {
    const result = await handleSearchDocs(
  ...
  it("should support partial engine name matching", async () => {
    const result = await handleSearchDocs(
