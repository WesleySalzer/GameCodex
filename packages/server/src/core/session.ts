...
const TOPIC_DOC_MAP: Record<string, string[]> = {
  ...
  "dialogue tree": ["ui-theory", "G62", "dialogue-narrative-theory"],
  ...
  "game systems": ["G10"],
  inventory: ["G10"],
  dialogue: ["G10", "dialogue-narrative-theory"],
  "dialogue system": ["dialogue-narrative-theory", "G62"],
  "narrative": ["dialogue-narrative-theory"],
  "branching dialogue": ["dialogue-narrative-theory"],
  "ink": ["dialogue-narrative-theory"],
  "yarn spinner": ["dialogue-narrative-theory"],
  "conversation": ["dialogue-narrative-theory", "G62"],
  "npc dialogue": ["dialogue-narrative-theory", "G62"],
  "choice system": ["dialogue-narrative-theory"],
  "quest log": ["dialogue-narrative-theory"],
  "quest system": ["dialogue-narrative-theory"],
  "relationship system": ["dialogue-narrative-theory"],
  "affinity": ["dialogue-narrative-theory"],
  "bark": ["dialogue-narrative-theory"],
  "cutscene": ["dialogue-narrative-theory", "godot-arch/G8"],
  "voice acting": ["dialogue-narrative-theory", "audio-theory"],
  "typewriter": ["dialogue-narrative-theory", "ui-theory", "godot-arch/G8"],
  "save/load": ["G10"],
