# GameCodex — R&D Project Brief

**Owner:** s
**Date:** 2026-03-16
**Repo:** gamecodex (GitHub, public)
...
- Pro content served via HTTPS API (e.g. `api.gamecodex.com`)
...
| **Package** | npm: gamecodex |
| **Config** | `~/.gamecodex/license.json` or `GAMEDEV_MCP_LICENSE` env var |
